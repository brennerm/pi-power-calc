  ...
  render() {
    return (
      <div className="App container">
        ...
        <p className="row">
          Calculate the required battery capacity to power your Raspberry Pi model (including Zero, Zero W, Zero 2 W, Pico, 1 A, 1 A+, 1 B, 1 B+, 2 B, 3 B+, 4 B, 400) for your desired run time.
        </p>
        <form>
